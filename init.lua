...
-- Keep the current selected search occurence in the middle of the window
...
-- [[ SYNTAX INSPECTION KEYMAPS ]]
vim.keymap.set('n', '<leader>st', vim.cmd.InspectTree)
